...
namespace hieutran02grc.WebBanSach.Migrations
{
    ...
    [Migration("20230117130636_addedidentitycore2")]
    partial class addedidentitycore2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hieutran02grc.WebBanSach.Data.Category", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("hieutran02grc.WebBanSach.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("hieutran02grc.WebBanSach.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("hieutran02grc.WebBanSach.Data.Books", b =>
                {
                    b.HasOne("hieutran02grc.WebBanSach.Data.Category", null)
                        .WithMany("Books")
